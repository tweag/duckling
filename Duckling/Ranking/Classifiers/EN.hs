...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44139711733422765,
                                 ...
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.48863636973214),
                                    ("hourday", -3.7001790093678695), ("dayhour", -3.1536353029998),
                                    ("monthday", -4.99946199349813),
                                    ("monthyear", -3.7954891891721947),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.404927101606295),
                                    ("Christmasyear", -5.404927101606295),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.404927101606295),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.711779921046349),
                                    ("<time-of-day> am|pmintersect", -4.152164133110927),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.404927101606295),
                                    ("Marchyear", -5.404927101606295),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -4.99946199349813),
                                    ("intersect<time-of-day> am|pm", -5.404927101606295),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.404927101606295),
                                    ("monthhour", -4.99946199349813),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.404927101606295),
                                    ("dayday", -3.39002408106403),
                                    ("Thanksgiving Dayyear", -4.99946199349813),
                                    ("<time> <part-of-day>at <time-of-day>", -5.404927101606295),
                                    ("mm/ddat <time-of-day>", -5.404927101606295),
                                    ("tonightat <time-of-day>", -5.404927101606295),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.711779921046349),
                                    ("today<time-of-day> am|pm", -5.404927101606295),
                                    ("Februarythe <day-of-month> (ordinal)", -4.99946199349813),
                                    ("at <time-of-day><time> <part-of-day>", -5.404927101606295),
                                    ("mm/dd<time-of-day> am|pm", -5.404927101606295),
                                    ("hourhour", -4.152164133110927),
                                    ("<time-of-day> am|pmon <date>", -3.39002408106403),
                                    ("Wednesdaythis|last|next <cycle>", -5.404927101606295),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.900849704830021),
                                    ("dayyear", -3.2077025242700756),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.404927101606295),
                                    ("<time-of-day> am|pmtomorrow", -4.711779921046349),
                                    ("minutehour", -4.48863636973214),
                                    ("Mother's Dayyear", -5.404927101606295),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -4.99946199349813),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.7001790093678695),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.404927101606295),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.48863636973214),
                                    ("Mondayin|during the <part-of-day>", -5.404927101606295),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.99946199349813),
                                    ("intersectin|during the <part-of-day>", -5.404927101606295),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.404927101606295),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -4.48863636973214),
                                    ("at <time-of-day>intersect", -4.99946199349813),
                                    ...
                                    ("minuteday", -2.0037297199441397),
                                    ("absorption of , after named dayintersect",
                                     -5.404927101606295),
                                    ("Octoberyear", -4.152164133110927),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.404927101606295),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.404927101606295),
                                    ("year<time-of-day> am|pm", -5.404927101606295),
                                    ("Septemberyear", -4.99946199349813),
                                    ("at <time-of-day>on <date>", -4.306314812938186),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.711779921046349),
                                    ("Halloweenyear", -5.404927101606295),
                                    ("dayweek", -5.404927101606295),
                                    ("weekyear", -4.99946199349813),
                                    ("hh:mmin|during the <part-of-day>", -4.711779921046349),
                                    ("Father's Dayyear", -5.404927101606295),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -4.99946199349813),
                                    ("February<time> <part-of-day>", -5.404927101606295),
                                    ("Martin Luther King's Dayyear", -4.99946199349813),
                                    ("tomorrowat <time-of-day>", -4.711779921046349),
                                    ("between <time> and <time>on <date>", -4.711779921046349),
                                    ("at <time-of-day>tomorrow", -4.99946199349813),
                                    ("tomorrow<time-of-day> am|pm", -5.404927101606295),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.404927101606295),
                                    ("Labor Dayyear", -5.404927101606295),
                                    ("Februaryintersect", -5.404927101606295),
                                    ("last <cycle> of <time>year", -4.711779921046349),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.404927101606295),
                                    ("yearminute", -5.404927101606295)],
                               n = 164},
                   koData =
                     ClassData{prior = -1.030404038641576, unseen = -5.703782474656201,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.0072963928307415),
                                    ("hourday", -5.0072963928307415),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.0072963928307415),
                                    ("dayhour", -3.215536923602686),
                                    ("daymonth", -2.9923933722884763),
                                    ("monthday", -4.601831284722577),
                                    ("monthyear", -5.0072963928307415),
                                    ("intersecthh:mm", -5.0072963928307415),
                                    ("until <time-of-day><time-of-day> am|pm", -5.0072963928307415),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.314149212270796),
                                    ("<time-of-day> am|pmintersect", -3.7545334243353734),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.314149212270796),
                                    ("Tuesdayafter <time-of-day>", -5.0072963928307415),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.0072963928307415),
                                    ("absorption of , after named dayJuly", -4.601831284722577),
                                    ("monthhour", -4.601831284722577),
                                    ("todayat <time-of-day>", -5.0072963928307415),
                                    ("dayday", -5.0072963928307415),
                                    ("mm/ddat <time-of-day>", -4.601831284722577),
                                    ("<time-of-day> am|pmon <date>", -3.7545334243353734),
                                    ("dayyear", -4.091005660956586),
                                    ("Thursdayat <time-of-day>", -5.0072963928307415),
                                    ("August<time-of-day> am|pm", -5.0072963928307415),
                                    ("monthminute", -5.0072963928307415),
                                    ("<time-of-day> am|pmtomorrow", -5.0072963928307415),
                                    ("Thursdayhh:mm", -5.0072963928307415),
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.0072963928307415),
                                    ("minutemonth", -3.503218996054467),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.601831284722577),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.601831284722577),
                                    ("Aprilyear", -5.0072963928307415),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.601831284722577),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.0072963928307415),
                                    ("yesterday<time-of-day> am|pm", -5.0072963928307415),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.091005660956586),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.0072963928307415),
                                    ("until <time-of-day>on <date>", -4.314149212270796),
                                    ("at <time-of-day>intersect", -4.601831284722577),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0072963928307415),
                                    ("dayminute", -3.061386243775428),
                                    ("intersectSeptember", -3.503218996054467),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.0072963928307415),
                                    ("minuteday", -2.203936011924206),
                                    ("absorption of , after named dayintersect",
                                     -5.0072963928307415),
                                    ("Februaryin|during the <part-of-day>", -5.0072963928307415),
                                    ("yearhh:mm", -5.0072963928307415),
                                    ("hh:mmon <date>", -3.503218996054467),
                                    ("absorption of , after named daySeptember",
                                     -4.091005660956586),
                                    ("on <date>September", -4.601831284722577),
                                    ("at <time-of-day>on <date>", -4.601831284722577),
                                    ("absorption of , after named dayFebruary", -4.091005660956586),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.0072963928307415),
                                    ("tomorrowat <time-of-day>", -5.0072963928307415),
                                    ("tomorrow<time-of-day> am|pm", -5.0072963928307415),
                                    ("after <time-of-day><time-of-day> am|pm", -5.0072963928307415),
                                    ("after <time-of-day>year", -5.0072963928307415),
                                    ("yearminute", -5.0072963928307415)],
                               n = 91}}),
